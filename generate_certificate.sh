...
certbot certonly --agree-tos --standalone --expand \
	...
	-d todowoo.automagicdeveloper.com \
	-d invoicer.automagicdeveloper.com \
	-d forex.automagicdeveloper.com \
	-d resume.automagicdeveloper.com \
	-d insightsdashboard.automagicdeveloper.com \
	-d footprints.automagicdeveloper.com \
